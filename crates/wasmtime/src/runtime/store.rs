...
pub struct StoreOpaque {
    ...
    preemptive_threads: crate::preemptive::PreemptiveThreads,
...
impl<T> Store<T> {
    ...
    pub fn spawn_wasm_thread(
        ...
        export: &str,
        params: (),
    ) -> Result<crate::preemptive::WasmThreadHandle>
    where
        T: Send + 'static,
    {
        ensure!(
...
"
    ...
    #[cfg(all(feature = "runtime", feature = "async", target_has_atomic = "64"))]
    pub(crate) fn preemptive_threads_mut(&mut self) -> &mut crate::preemptive::PreemptiveThreads {
